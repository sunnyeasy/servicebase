...
@MotanService
public class PushAuthRpcServiceImpl implements PushAuthRpcService {
    private static final Logger logger = LoggerFactory.getLogger(PushAuthRpcServiceImpl.class);
